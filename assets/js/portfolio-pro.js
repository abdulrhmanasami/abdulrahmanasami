...
(function () {
  ...
  const i18n = {
    de: {
      ...
      nav_resume: 'Lebenslauf', nav_portfolio: 'Portfolio', nav_enterprise: 'Enterprise', nav_contact: 'Kontakt',
    ...
    en: {
      ...
      nav_resume: 'Resume', nav_portfolio: 'Portfolio', nav_enterprise: 'Enterprise', nav_contact: 'Contact',
    ...
    ar: {
      ...
      nav_resume: 'السيرة الذاتية', nav_portfolio: 'أعمالي', nav_enterprise: 'مؤسسات', nav_contact: 'تواصل',
