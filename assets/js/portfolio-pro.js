...
(function () {
  ...
  const i18n = {
    de: {
      ...
      lab1_title: 'Omaria E-Commerce', lab1_desc: 'Machbarkeitsstudien und Infrastruktur-Design für eine E-Commerce-Plattform (Private Label).',
      lab2_title: 'Subscription Aggregator', lab2_desc: 'SaaS-Konzept zur zentralen Verwaltung digitaler Abonnements.',
      lab3_title: 'Codex-CLI & AI Agents', lab3_desc: 'TUI/CLI-Tools zur Modellierung und Überwachung autonomer KI-Agenten.',
      tag_ecommerce: 'E-Commerce', tag_conceptlab: 'Konzept', tag_automation: 'Automation',
    ...
    en: {
      ...
      lab1_title: 'Omaria Retail Platform', lab1_desc: 'Feasibility studies and architecture design for a private label e-commerce brand.',
      lab2_title: 'Subscription Aggregator', lab2_desc: 'SaaS concept mapping for a centralized digital subscription management ecosystem.',
      lab3_title: 'Codex AI Agents', lab3_desc: 'Advanced TUI/CLI engineering for autonomous AI agent orchestration and monitoring.',
      tag_ecommerce: 'E-Commerce', tag_conceptlab: 'Concept', tag_automation: 'Automation',
    ...
    ar: {
      ...
      lab1_title: 'منصة أوماريا للتجارة', lab1_desc: 'دراسات جدوى وبنية تحتية لعلامة تجارية خاصة (Private Label) مخصصة لقطاع التجارة الإلكترونية.',
      lab2_title: 'مُجمّع الاشتراكات SaaS', lab2_desc: 'مخطط وبحث لمنصة لإدارة وتنظيم الاشتراكات الرقمية المتعددة في مكان واحد.',
      lab3_title: 'وكلاء الذكاء الاصطناعي', lab3_desc: 'أدوات برمجية متقدمة (TUI/CLI) لإدارة وتوجيه وكلاء الذكاء الاصطناعي المستقلين (AI Agents).',
      tag_ecommerce: 'تجارة إلكترونية', tag_conceptlab: 'مفهوم ناشئ', tag_automation: 'أتمتة',
