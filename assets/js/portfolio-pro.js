...
(function () {
  ...
  const i18n = {
    de: {
      ...
      proj1_desc: 'Entwicklung und Konstruktion eines automatisierten Förderbandsystems für die Industrie.',
      proj2_desc: 'App zur gemeinsamen Nutzung von Dokumenten für Schüler und Lehrer.',
      proj3_desc: 'Prototyp für ein Tech-Startup im Bereich digitale Lösungen.',
      proj4_desc: 'Innovativer digitaler Stift, der direkt am Finger getragen wird – Konzept & Produktstudie.',
      proj5_desc: 'Smarte App zum Bestellen von Shawarma beim nächsten Restaurant — UX-Studie.',
      proj6_desc: 'Vergleichsstudie von E-Learning-Apps auf dem deutschen Markt.',
      proj7_desc: 'Detaillierter Businessplan für eine Aufgabenmanagement-App.',
      tag_concept: 'Konzept', tag_prod_design: 'Produktdesign',
      tag_web: 'Webentwicklung', tag_biz: 'Business',
      tag_planning: 'Planung', tag_research: 'Marktforschung',
    ...
    en: {
      ...
      proj1_desc: 'Design and engineering of an automated conveyor belt system for industrial use.',
      proj2_desc: 'App for collaborative document sharing between students and teachers.',
      proj3_desc: 'Prototype for a tech startup in the field of digital solutions.',
      proj4_desc: 'Innovative digital pen worn on the finger — concept & product study.',
      proj5_desc: 'Smart app for ordering shawarma from nearby restaurants — UX study.',
      proj6_desc: 'Comparative study of e-learning apps in the German market.',
      proj7_desc: 'Detailed business plan for a task management app.',
      tag_concept: 'Concept', tag_prod_design: 'Product Design',
      tag_web: 'Web Dev', tag_biz: 'Business',
      tag_planning: 'Planning', tag_research: 'Market Research',
    ...
    ar: {
      ...
      proj1_desc: 'تصميم وهندسة نظام حزام ناقل صناعي آلي.',
      proj2_desc: 'تطبيق لمشاركة المستندات بين الطلاب والمعلمين.',
      proj3_desc: 'نموذج أولي لشركة ناشئة في مجال الحلول الرقمية.',
      proj4_desc: 'قلم رقمي مبتكر يُرتدى على الإصبع — دراسة مفهومية.',
      proj5_desc: 'تطبيق ذكي لطلب الشاورما من أقرب مطعم — دراسة UX.',
      proj6_desc: 'دراسة مقارنة لتطبيقات التعلم الإلكتروني في السوق الألمانية.',
      proj7_desc: 'خطة عمل تجارية مفصلة لتطبيق إدارة المهام.',
      tag_concept: 'مفهوم', tag_prod_design: 'تصميم منتج',
      tag_web: 'تطوير ويب', tag_biz: 'أعمال',
      tag_planning: 'تخطيط', tag_research: 'أبحاث السوق',
