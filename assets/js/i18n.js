...
window.PORTFOLIO_I18N = {
  de: {
    ...
    proj7_desc: 'Durchführung einer fundierten State-of-the-Art (SOTA) Gap-Analyse von Audio-KI-Modellen, die in der Entwicklung der "Thunderound Engine" mündete. Diese Engine verbindet traditionelle DSP-Methoden mit Machine Learning für komplexe Aufgaben wie MIDI-gesteuerte Audiosignaltrennung und Neural Mask Refining. Das Projekt umfasste die Erforschung algorithmischer Grenzen generativer Akustik sowie die Optimierung rechenintensiver Prozesse durch GPU-Offloading.',
  ...
  en: {
    ...
    proj7_desc: 'Conducted a rigorous State-of-the-Art (SOTA) Gap Analysis of Audio AI models, culminating in the development of the "Thunderound Engine". This custom engine bridges traditional DSP with Machine Learning, featuring MIDI-guided audio source separation and Neural Mask Refining. The project involved exploring algorithmic limitations of generative acoustics and optimizing heavy compute via GPU offloading architectures.',
  ...
  ar: {
    ...
    proj7_desc: 'إجراء تحليل فجوات استراتيجي (SOTA Gap Analysis) لنماذج الذكاء الاصطناعي الصوتي، والذي تُوّج بتطوير محرك "Thunderound Engine". يدمج هذا المحرك بين المعالجة الرقمية للإشارات (DSP) والتعلم الآلي (ML) لتنفيذ مهام معقدة مثل العزل الصوتي الموجه عبر (MIDI-Guided Separation) وتنقية القناع العصبي (Neural Mask Refining). شمل العمل تحسين البنية التحتية لتفريغ الحوسبة (GPU Offloading) واستكشاف الحدود الخوارزمية للتقنيات السمعية التوليدية.',
